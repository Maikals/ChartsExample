...
public class ChartDataDomainEntity extends BaseDomainEntity {
    private ChartDomainValues[] chartDomainValues;

    public ChartDomainValues[] getChartDomainValues() {
        return chartDomainValues;
    }

    public void setChartDomainValues(ChartDomainValues[] chartDomainValues) {
        this.chartDomainValues = chartDomainValues;
    }
}
